...
def Unet(backbone_name='vgg16',
         ...
         freeze_encoder=False,  # set encoder layers weights as non-trainable
         skip_connections='default',  # a list of layers from top of model
         decoder_block_type='upsampling', # upsampling or transpose
         decoder_filters=(256,128,64,32,16),  # number of conv filters in last upsample block
    ...
    # return VGG16(input_shape=input_shape,input_tensor=input_tensor,weights=encoder_weights,include_top=False))
